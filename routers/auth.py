...
from auth.api_key_handler import generate_api_key, hash_api_key
from auth.dependencies import get_current_user, get_current_user_jwt
...
def refresh_access_token(
    ...
    token_hash = hash_api_key(payload.refresh_token)
